...
int generate_move_shuffle()
{
 ...
 if( (HISTORY_LATEST->x1 - HISTORY_LATEST->older->x1) + (HISTORY_LATEST->y1 - HISTORY_LATEST->older->y1) == 1 )
 if( (HISTORY_LATEST->x1 - HISTORY_LATEST->older->x2) + (HISTORY_LATEST->y1 - HISTORY_LATEST->older->y2) == 1 )
 if( (HISTORY_LATEST->x1 - HISTORY_LATEST->older->x3) + (HISTORY_LATEST->y1 - HISTORY_LATEST->older->y3) == 1 )

 if( (HISTORY_LATEST->x2 - HISTORY_LATEST->older->x1) + (HISTORY_LATEST->y2 - HISTORY_LATEST->older->y1) == 1 )
 if( (HISTORY_LATEST->x2 - HISTORY_LATEST->older->x2) + (HISTORY_LATEST->y2 - HISTORY_LATEST->older->y2) == 1 )
 if( (HISTORY_LATEST->x2 - HISTORY_LATEST->older->x3) + (HISTORY_LATEST->y2 - HISTORY_LATEST->older->y3) == 1 )

 if( (HISTORY_LATEST->x3 - HISTORY_LATEST->older->x1) + (HISTORY_LATEST->y3 - HISTORY_LATEST->older->y1) == 1 )
 if( (HISTORY_LATEST->x3 - HISTORY_LATEST->older->x2) + (HISTORY_LATEST->y3 - HISTORY_LATEST->older->y2) == 1 )
 if( (HISTORY_LATEST->x3 - HISTORY_LATEST->older->x3) + (HISTORY_LATEST->y3 - HISTORY_LATEST->older->y3) == 1 )
